...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeElyaCoinV2Amount"))
        settings.setValue("nAnonymizeElyaCoinV2Amount", 1000);
    nAnonymizeElyaCoinV2Amount = settings.value("nAnonymizeElyaCoinV2Amount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeElyaCoinV2Amount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeElyaCoinV2Amount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeElyaCoinV2Amount:
            return QVariant(nAnonymizeElyaCoinV2Amount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeElyaCoinV2Amount:
            nAnonymizeElyaCoinV2Amount = value.toInt();
            settings.setValue("nAnonymizeElyaCoinV2Amount", nAnonymizeElyaCoinV2Amount);
            emit AnonymizeElyaCoinV2AmountChanged(nAnonymizeElyaCoinV2Amount);
            break;
        default:
            break;
        }
