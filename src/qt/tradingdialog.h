...
private slots:
    ...
    QString BuyELYA(QString OrderType, double Quantity, double Rate);
    QString SellELYA(QString OrderType, double Quantity, double Rate);
