...
/**
 * Split ElyaCoinV2 command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ElyaCoinV2 RPC console.") + "<br>" +
