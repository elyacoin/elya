...
const string strMessageMagic = "ElyaCoinV2 Signed Message:\n";
...
>>>>>>> d73567d42b43cec26b365a8669a21f6846ea2246
		nSubsidy = 10000000 * COIN;
	} else if (nHeight < (36000 * 1)) {
		nSubsidy = 360 * COIN;
	} else if (nHeight < (36000 * 2)) {
		nSubsidy = 320 * COIN;
	} else if (nHeight < (36000 * 3)) {
		nSubsidy = 300 * COIN;
	} else if (nHeight < (36000 * 4)) {
		nSubsidy = 280 * COIN;
	} else if (nHeight < (36000 * 5)) {
		nSubsidy = 260 * COIN;
	} else if (nHeight < (36000 * 6)) {
		nSubsidy = 240 * COIN;
	} else if (nHeight < (36000 * 7)) {
		nSubsidy = 220 * COIN;
	} else if (nHeight < (36000 * 8)) {
		nSubsidy = 200 * COIN;
	} else if (nHeight < (36000 * 9)) {
		nSubsidy = 180 * COIN;
	} else if (nHeight < (36000 * 10)) {
		nSubsidy = 160 * COIN;
	} else if (nHeight < (36000 * 11)) {
		nSubsidy = 140 * COIN;
	} else {
		nSubsidy = 120 * COIN;
	}
...
{
    RenameThread("ElyaCoinV2-loadblk");
